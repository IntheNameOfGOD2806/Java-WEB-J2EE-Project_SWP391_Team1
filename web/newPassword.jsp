                        ...
                        <div class="container bg-white rounded mt-2 mb-2 px-0">
                            ...
                            <div class="pt-3 pb-3">
                                <form class="form-horizontal" action="newPassword" method="POST">
                                    ...
                                    <h5 style="color: red; margin-left: 150px;">${requestScope.re}</h5>
                                    <h5 style="color: red; margin-left: 150px;">${requestScope.forgetPassChange}</h5>
                                    ...
                                    <div class="row justify-content-center">
                                        <h5>
                                            <span><a href="login.jsp"
                                                     class="text-danger"> Back to login</a></span>
                                        </h5>
                                    </div>
                                    <div
