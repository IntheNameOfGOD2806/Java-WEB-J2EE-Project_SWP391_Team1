    ...
    <body id="bg">
        <div class="page-wraper">
            ...
            <div class="page-content bg-white">
                <!-- inner page banner -->
                <div class="page-banner " style="background-image:url(marketing/assets/images/banner/banner2.jpg);">
                    <div class="container">
                    ...
                    <div class="section-area section-sp1">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <%for(Blog BL: Bl){%>
                                    <div class="blog-post blog-md clearfix" style="border-bottom-style: double;">
                                        <div class="ttr-post-media"> 
                                            <a href="BlogDetail?BlogID=<%=BL.getBlogId()%>"><img src="<%=BL.getPhoto()%>" alt=""></a> 
                                        </div>
                                        <div class="ttr-post-info" >
                                            <ul class="media-post">
                                                <li><i class="fa fa-calendar"></i><%=BL.getCreateDate()%></li>
                                                    <%
                ProfileDAO profileDAO = new ProfileDAO();
                Profile p = profileDAO.getProfileByAccountId(BL.getAccountId());
                                                    %>
                                                <li><i class="fa fa-user"></i><%=p.getFullName()%></li>
                                            </ul>
                                            <h5 class="post-title"><a href="BlogDetail?BlogID=<%=BL.getBlogId()%>"><%=BL.getTitle()%></a></h5>
                                            <p><%=BL.getBriefInfor()%></p>
                                            <div class="post-extra">
                                                <a href="BlogDetail?BlogID=<%=BL.getBlogId()%>" class="btn-link">READ MORE</a>
                                            </div>
                                        </div>
                                    </div>
                                    <%}%>
                                    ...
                                    <div class="pagination-bx rounded-sm gray clearfix">
                                        <ul class="pagination">
                                            <li class="previous"><c:forEach begin="${1}" end="${requestScope.num}"  var="i">
                                                    <a class="${i==page?"active":""}" href="ViewBlog?page=${i}">${i}</a>
                                                </c:forEach></li>
                                        </ul>
                                    </div>
                                    <!-- Pagination END -->
...
<!--    <script src='marketing/assets/vendors/switcher/switcher.js'></script>-->
</body>
