                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <div id="myElement" class="form-outline mb-4">
                                                <font color="red">${sessionScope.errorad}</font>
                                            </div>
                                ...
                                <c:forEach items="${listHouse}" var="lh">
                                    <tr>
                                        ...
                                        <td>
                                            <form id="houseForm${lh.houseID}" action="CreateAdsLandLord?houseID=${lh.houseID}" method="post">
                                                <select id="time${lh.houseID}" name="time">
                                                    <option value="0">Time</option>
                                                    <option value="1">1 Week</option>
                                                    <option value="2">1 Month</option>
                                                    <option value="3">3 Month</option>
                                                </select>
                                                <input  id="button1" type="button" onclick="createAd(${lh.houseID})"  value="Create">
                                            </form>
                                        </td>
                                    </tr>
                                </c:forEach>
