...
@WebServlet(name = "FeedbackControllerAjax", urlPatterns = {"/landlord-feedbackAjax"})

public class FeedbackControllerAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("display-all")) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("landlord/ViewFeedbackAjax.jsp");
